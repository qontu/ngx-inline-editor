# Native UI Inline-editor Angular (version 2.0+ or 4) component ([demo](demos))
...
ng2-inline-editor is a library of Angular (version 2.0+ or 4) that allows you to create editable elements.
